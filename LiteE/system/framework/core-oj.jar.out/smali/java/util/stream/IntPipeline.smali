...
.method private static adapt(Ljava/util/stream/Sink;)Ljava/util/function/IntConsumer;
    ...
    new-instance v0, Ljava/util/stream/-$Lambda$QgGTJrv63_zzBbeGjswm_UMqEbo$15;

    invoke-direct {v0, p0}, Ljava/util/stream/-$Lambda$QgGTJrv63_zzBbeGjswm_UMqEbo$15;-><init>(Ljava/lang/Object;)V
...
.method public final average()Ljava/util/OptionalDouble;
    ...
    .line 435
    new-instance v1, Ljava/util/stream/-$Lambda$QgGTJrv63_zzBbeGjswm_UMqEbo$10;

    invoke-direct {v1}, Ljava/util/stream/-$Lambda$QgGTJrv63_zzBbeGjswm_UMqEbo$10;-><init>()V

    .line 436
    new-instance v2, Ljava/util/stream/-$Lambda$QgGTJrv63_zzBbeGjswm_UMqEbo$8;

    invoke-direct {v2}, Ljava/util/stream/-$Lambda$QgGTJrv63_zzBbeGjswm_UMqEbo$8;-><init>()V

    .line 440
    new-instance v3, Ljava/util/stream/-$Lambda$QgGTJrv63_zzBbeGjswm_UMqEbo;

    invoke-direct {v3}, Ljava/util/stream/-$Lambda$QgGTJrv63_zzBbeGjswm_UMqEbo;-><init>()V
...
.method public final boxed()Ljava/util/stream/Stream;
    ...
    .line 221
    .local p0, "this":Ljava/util/stream/IntPipeline;, "Ljava/util/stream/IntPipeline<TE_IN;>;"
    new-instance v0, Ljava/util/stream/-$Lambda$QgGTJrv63_zzBbeGjswm_UMqEbo$5;

    invoke-direct {v0}, Ljava/util/stream/-$Lambda$QgGTJrv63_zzBbeGjswm_UMqEbo$5;-><init>()V
...
.method public final collect(Ljava/util/function/Supplier;Ljava/util/function/ObjIntConsumer;Ljava/util/function/BiConsumer;)Ljava/lang/Object;
    ...
    new-instance v0, Ljava/util/stream/-$Lambda$QgGTJrv63_zzBbeGjswm_UMqEbo$13;

    invoke-direct {v0, p3}, Ljava/util/stream/-$Lambda$QgGTJrv63_zzBbeGjswm_UMqEbo$13;-><init>(Ljava/lang/Object;)V
...
.method public final count()J
    ...
    .line 430
    .local p0, "this":Ljava/util/stream/IntPipeline;, "Ljava/util/stream/IntPipeline<TE_IN;>;"
    new-instance v0, Ljava/util/stream/-$Lambda$QgGTJrv63_zzBbeGjswm_UMqEbo$7;

    invoke-direct {v0}, Ljava/util/stream/-$Lambda$QgGTJrv63_zzBbeGjswm_UMqEbo$7;-><init>()V
...
.method public final distinct()Ljava/util/stream/IntStream;
    ...
    new-instance v1, Ljava/util/stream/-$Lambda$QgGTJrv63_zzBbeGjswm_UMqEbo$12;

    invoke-direct {v1}, Ljava/util/stream/-$Lambda$QgGTJrv63_zzBbeGjswm_UMqEbo$12;-><init>()V
...
.method public final max()Ljava/util/OptionalInt;
    ...
    invoke-direct {v0}, Ljava/util/stream/-$Lambda$QgGTJrv63_zzBbeGjswm_UMqEbo$2;-><init>()V
...
.method public final sum()I
    ...
    .line 415
    .local p0, "this":Ljava/util/stream/IntPipeline;, "Ljava/util/stream/IntPipeline<TE_IN;>;"
    new-instance v0, Ljava/util/stream/-$Lambda$QgGTJrv63_zzBbeGjswm_UMqEbo$4;

    invoke-direct {v0}, Ljava/util/stream/-$Lambda$QgGTJrv63_zzBbeGjswm_UMqEbo$4;-><init>()V
...
.method public final summaryStatistics()Ljava/util/IntSummaryStatistics;
    ...
    .line 451
    .local p0, "this":Ljava/util/stream/IntPipeline;, "Ljava/util/stream/IntPipeline<TE_IN;>;"
    new-instance v0, Ljava/util/stream/-$Lambda$QgGTJrv63_zzBbeGjswm_UMqEbo$11;

    invoke-direct {v0}, Ljava/util/stream/-$Lambda$QgGTJrv63_zzBbeGjswm_UMqEbo$11;-><init>()V

    new-instance v1, Ljava/util/stream/-$Lambda$QgGTJrv63_zzBbeGjswm_UMqEbo$9;

    invoke-direct {v1}, Ljava/util/stream/-$Lambda$QgGTJrv63_zzBbeGjswm_UMqEbo$9;-><init>()V

    .line 452
    new-instance v2, Ljava/util/stream/-$Lambda$QgGTJrv63_zzBbeGjswm_UMqEbo$1;

    invoke-direct {v2}, Ljava/util/stream/-$Lambda$QgGTJrv63_zzBbeGjswm_UMqEbo$1;-><init>()V
...
.method public final toArray()[I
    ...
    .line 503
    .local p0, "this":Ljava/util/stream/IntPipeline;, "Ljava/util/stream/IntPipeline<TE_IN;>;"
    new-instance v0, Ljava/util/stream/-$Lambda$QgGTJrv63_zzBbeGjswm_UMqEbo$6;

    invoke-direct {v0}, Ljava/util/stream/-$Lambda$QgGTJrv63_zzBbeGjswm_UMqEbo$6;-><init>()V
