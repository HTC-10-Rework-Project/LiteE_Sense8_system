...
.method public opEvaluateParallel(Ljava/util/stream/PipelineHelper;Ljava/util/Spliterator;Ljava/util/function/IntFunction;)Ljava/util/stream/Node;
    ...
    new-instance v5, Ljava/util/stream/-$Lambda$9RlwRKfo_sNL8-VA-0-rDqK5gEM$3;

    invoke-direct {v5, v4, v3}, Ljava/util/stream/-$Lambda$9RlwRKfo_sNL8-VA-0-rDqK5gEM$3;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
...
.method reduce(Ljava/util/stream/PipelineHelper;Ljava/util/Spliterator;)Ljava/util/stream/Node;
    ...
    .local p1, "helper":Ljava/util/stream/PipelineHelper;, "Ljava/util/stream/PipelineHelper<TT;>;"
    .local p2, "spliterator":Ljava/util/Spliterator;, "Ljava/util/Spliterator<TP_IN;>;"
    new-instance v1, Ljava/util/stream/-$Lambda$9RlwRKfo_sNL8-VA-0-rDqK5gEM$2;

    invoke-direct {v1}, Ljava/util/stream/-$Lambda$9RlwRKfo_sNL8-VA-0-rDqK5gEM$2;-><init>()V

    new-instance v2, Ljava/util/stream/-$Lambda$9RlwRKfo_sNL8-VA-0-rDqK5gEM;

    invoke-direct {v2}, Ljava/util/stream/-$Lambda$9RlwRKfo_sNL8-VA-0-rDqK5gEM;-><init>()V

    .line 63
    new-instance v3, Ljava/util/stream/-$Lambda$9RlwRKfo_sNL8-VA-0-rDqK5gEM$1;

    invoke-direct {v3}, Ljava/util/stream/-$Lambda$9RlwRKfo_sNL8-VA-0-rDqK5gEM$1;-><init>()V
