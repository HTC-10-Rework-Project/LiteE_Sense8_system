...
.method protected doLeaf()Ljava/util/stream/Node;
    ...
    iget-object v3, p0, Ljava/util/stream/Nodes$CollectorTask;->spliterator:Ljava/util/Spliterator;
    ...
    iget-object v2, p0, Ljava/util/stream/Nodes$CollectorTask;->spliterator:Ljava/util/Spliterator;
...
.method public onCompletion(Ljava/util/concurrent/CountedCompleter;)V
    ...
    invoke-virtual {p0}, Ljava/util/stream/Nodes$CollectorTask;->isLeaf()Z
    ...
    iget-object v0, p0, Ljava/util/stream/Nodes$CollectorTask;->leftChild:Ljava/util/stream/AbstractTask;

    check-cast v0, Ljava/util/stream/Nodes$CollectorTask;

    invoke-virtual {v0}, Ljava/util/stream/Nodes$CollectorTask;->getLocalResult()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Ljava/util/stream/Node;

    iget-object v1, p0, Ljava/util/stream/Nodes$CollectorTask;->rightChild:Ljava/util/stream/AbstractTask;

    check-cast v1, Ljava/util/stream/Nodes$CollectorTask;

    invoke-virtual {v1}, Ljava/util/stream/Nodes$CollectorTask;->getLocalResult()Ljava/lang/Object;
    ...
    invoke-virtual {p0, v0}, Ljava/util/stream/Nodes$CollectorTask;->setLocalResult(Ljava/lang/Object;)V
