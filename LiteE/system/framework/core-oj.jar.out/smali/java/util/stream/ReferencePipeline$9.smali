.class Ljava/util/stream/ReferencePipeline$9;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Ljava/util/stream/ReferencePipeline;->flatMapToDouble(Ljava/util/function/Function;)Ljava/util/stream/DoubleStream;
.end annotation
...
.method constructor <init>(Ljava/util/stream/ReferencePipeline;Ljava/util/stream/AbstractPipeline;Ljava/util/stream/StreamShape;ILjava/util/function/Function;)V
    ...
    iput-object p1, p0, Ljava/util/stream/ReferencePipeline$9;->this$0:Ljava/util/stream/ReferencePipeline;

    iput-object p5, p0, Ljava/util/stream/ReferencePipeline$9;->val$mapper:Ljava/util/function/Function;
...
.method public opWrapSink(ILjava/util/stream/Sink;)Ljava/util/stream/Sink;
    ...
    new-instance v0, Ljava/util/stream/ReferencePipeline$9$1;

    iget-object v1, p0, Ljava/util/stream/ReferencePipeline$9;->val$mapper:Ljava/util/function/Function;

    invoke-direct {v0, p0, p2, v1}, Ljava/util/stream/ReferencePipeline$9$1;-><init>(Ljava/util/stream/ReferencePipeline$9;Ljava/util/stream/Sink;Ljava/util/function/Function;)V
