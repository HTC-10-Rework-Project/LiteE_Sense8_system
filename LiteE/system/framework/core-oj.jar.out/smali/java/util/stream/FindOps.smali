...
.method public static makeDouble(Z)Ljava/util/stream/TerminalOp;
    ...
    .line 95
    new-instance v4, Ljava/util/stream/-$Lambda$ioGbka_-VkWTFjRjTt8T4zzsxgk;

    invoke-direct {v4}, Ljava/util/stream/-$Lambda$ioGbka_-VkWTFjRjTt8T4zzsxgk;-><init>()V

    new-instance v5, Ljava/util/stream/-$Lambda$ioGbka_-VkWTFjRjTt8T4zzsxgk$4;

    invoke-direct {v5}, Ljava/util/stream/-$Lambda$ioGbka_-VkWTFjRjTt8T4zzsxgk$4;-><init>()V
...
.method public static makeInt(Z)Ljava/util/stream/TerminalOp;
    ...
    .line 71
    new-instance v4, Ljava/util/stream/-$Lambda$ioGbka_-VkWTFjRjTt8T4zzsxgk$1;

    invoke-direct {v4}, Ljava/util/stream/-$Lambda$ioGbka_-VkWTFjRjTt8T4zzsxgk$1;-><init>()V

    new-instance v5, Ljava/util/stream/-$Lambda$ioGbka_-VkWTFjRjTt8T4zzsxgk$5;

    invoke-direct {v5}, Ljava/util/stream/-$Lambda$ioGbka_-VkWTFjRjTt8T4zzsxgk$5;-><init>()V
...
.method public static makeLong(Z)Ljava/util/stream/TerminalOp;
    ...
    .line 83
    new-instance v4, Ljava/util/stream/-$Lambda$ioGbka_-VkWTFjRjTt8T4zzsxgk$2;

    invoke-direct {v4}, Ljava/util/stream/-$Lambda$ioGbka_-VkWTFjRjTt8T4zzsxgk$2;-><init>()V

    new-instance v5, Ljava/util/stream/-$Lambda$ioGbka_-VkWTFjRjTt8T4zzsxgk$6;

    invoke-direct {v5}, Ljava/util/stream/-$Lambda$ioGbka_-VkWTFjRjTt8T4zzsxgk$6;-><init>()V
...
.method public static makeRef(Z)Ljava/util/stream/TerminalOp;
    ...
    .line 59
    new-instance v4, Ljava/util/stream/-$Lambda$ioGbka_-VkWTFjRjTt8T4zzsxgk$3;

    invoke-direct {v4}, Ljava/util/stream/-$Lambda$ioGbka_-VkWTFjRjTt8T4zzsxgk$3;-><init>()V

    new-instance v5, Ljava/util/stream/-$Lambda$ioGbka_-VkWTFjRjTt8T4zzsxgk$7;

    invoke-direct {v5}, Ljava/util/stream/-$Lambda$ioGbka_-VkWTFjRjTt8T4zzsxgk$7;-><init>()V
