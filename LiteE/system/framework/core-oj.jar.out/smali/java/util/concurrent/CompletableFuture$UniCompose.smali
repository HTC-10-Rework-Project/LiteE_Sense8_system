...
.method final tryFire(I)Ljava/util/concurrent/CompletableFuture;
    ...
    .line 959
    iget-object v1, p0, Ljava/util/concurrent/CompletableFuture$UniCompose;->dep:Ljava/util/concurrent/CompletableFuture;
    ...
    :goto_0
    invoke-virtual {v1, v0, v4, v2}, Ljava/util/concurrent/CompletableFuture;->uniCompose(Ljava/util/concurrent/CompletableFuture;Ljava/util/function/Function;Ljava/util/concurrent/CompletableFuture$UniCompose;)Z
    ...
    .line 962
    :cond_2
    iput-object v3, p0, Ljava/util/concurrent/CompletableFuture$UniCompose;->dep:Ljava/util/concurrent/CompletableFuture;

    iput-object v3, p0, Ljava/util/concurrent/CompletableFuture$UniCompose;->src:Ljava/util/concurrent/CompletableFuture;

    iput-object v3, p0, Ljava/util/concurrent/CompletableFuture$UniCompose;->fn:Ljava/util/function/Function;
