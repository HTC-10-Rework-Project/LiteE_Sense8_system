...
.method final tryFire(I)Ljava/util/concurrent/CompletableFuture;
    ...
    .line 1175
    iget-object v2, p0, Ljava/util/concurrent/CompletableFuture$BiAccept;->dep:Ljava/util/concurrent/CompletableFuture;
    ...
    iget-object v1, p0, Ljava/util/concurrent/CompletableFuture$BiAccept;->snd:Ljava/util/concurrent/CompletableFuture;
    ...
    .line 1178
    :cond_2
    iput-object v4, p0, Ljava/util/concurrent/CompletableFuture$BiAccept;->dep:Ljava/util/concurrent/CompletableFuture;

    iput-object v4, p0, Ljava/util/concurrent/CompletableFuture$BiAccept;->src:Ljava/util/concurrent/CompletableFuture;

    iput-object v4, p0, Ljava/util/concurrent/CompletableFuture$BiAccept;->snd:Ljava/util/concurrent/CompletableFuture;
